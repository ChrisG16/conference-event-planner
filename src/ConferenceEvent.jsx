...
const ConferenceEvent = () => {
  ...
  const remainingAuditoriumQuantity = 3 - venueItems.find(item => item.name === "Sala de Auditorio (Capacidad: 200)").quantity;
  ...
  const handleAddToCart = (index) => {
    if (venueItems[index].name === "Sala de Auditorio (Capacidad: 200)" && venueItems[index].quantity >= 3) {
      return;
    }
  ...
  const ItemsDisplay = ({ items }) => {
    ...
    return <>
      <div className="display_box1">
        {items.length === 0 && <p>Ningún artículo seleccionado</p>}
  ...
  return (
    <>
      <navbar className="navbar_event_conference">
        <div className="company_logo">Planificador de Conferencias</div>
            ...
            <div className="items-information">
                  ...
                  {venueItems.map((item, index) => (
                    <div className="venue_main" key={index}>
                      ...
                      <div className="button_container">
                        {venueItems[index].name === "Sala de Auditorio (Capacidad: 200)" ? (
              ...
              <div id="addons" className="venue_container container_main">
                ...
                <div className="text">
                  ...
                  <h1>Selección de Add-ons (Complementos)</h1>

                </div>
                <div className="addons_selection">
                  {avItems.map((item, index) => (
                    <div className="av_main venue_main" key={index}>
                      <div className="img">
                        <img src={item.img} alt={item.name} />
                      </div>
                      <div className="text">{item.name}</div>
              ...
              <div id="meals" className="venue_container container_main">
                ...
                <div className="input-container venue_selection">
                  <label htmlFor="numberOfPeople"><h3>Número de Asistentes:</h3></label>
                  <input
                    type="number"
                ...
                <div className="meal_selection">
                  {mealsItems.map((item, index) => (
                    <div className="meat_item" key={index} style={{ padding: 15 }}>
                      <div className="inner">
                        <input
                          type="checkbox"
                          id={`meal_${index}`}
